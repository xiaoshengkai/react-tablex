    ...
    (columns: ColumnsType<RecordType>): ColumnsType<RecordType> => {
      ...
      if (selectionType !== 'radio') {
        ...
        if (mergedSelections) {
          ...
          // 魔改
          const overlay = <Menu mode="horizontal" items={menu.items} />

          customizeSelections = (
            <div className={`${prefixCls}-selection-extra`}>
              {/* <Dropdown overlay={overlay} getPopupContainer={getPopupContainer}> */}
               <Dropdown menu={overlay} getPopupContainer={getPopupContainer}>
                <span>
                  <DownOutlined />
                </span>
              </Dropdown>
