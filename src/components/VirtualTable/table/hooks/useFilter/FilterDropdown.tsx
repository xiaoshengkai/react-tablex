...
import {Icon, Button, Checkbox, Dropdown, Empty, Radio, Tree } from 'antd'
import type {
  ColumnFilterItem,
  ColumnType,
  FilterKey,
...
const FilterDropdown = <RecordType extends AnyObject = AnyObject>(
    ...
    dropdownContent = (
      <>
        ...
        <div className={`${prefixCls}-dropdown-btns`}>
          <Button size="small" disabled={getResetDisabled()} onClick={() => onReset()}>
            重置
          </Button>
  ...
  return (
    <div className={`${prefixCls}-column`}>
      ...
      <Dropdown {...zcyDropdownProps} >{mergedDropdownProps.children}</Dropdown>
    </div>
  );
};
